...
[![Build Status](https://travis-ci.org/tinyhole/pblib/protoreflect.svg?branch=master)](https://travis-ci.org/tinyhole/pblib/protoreflect/branches)
[![Go Report Card](https://goreportcard.com/badge/github.com/tinyhole/pblib/protoreflect)](https://goreportcard.com/report/github.com/tinyhole/pblib/protoreflect)
...
[![GoDoc](https://godoc.org/github.com/tinyhole/pblib/protoreflect?status.svg)](https://godoc.org/github.com/tinyhole/pblib/protoreflect)

----
## Descriptors: The Language Model of Protocol Buffers

```go
import "github.com/tinyhole/pblib/protoreflect/desc"
```
...
*[Read more ≫](https://godoc.org/github.com/tinyhole/pblib/protoreflect/desc)*

```go
import "github.com/tinyhole/pblib/protoreflect/desc/protoparse"
```
...
*[Read more ≫](https://godoc.org/github.com/tinyhole/pblib/protoreflect/desc/protoparse)*

```go
import "github.com/tinyhole/pblib/protoreflect/desc/protoprint"
```
...
*[Read more ≫](https://godoc.org/github.com/tinyhole/pblib/protoreflect/desc/protoprint)*

```go
import "github.com/tinyhole/pblib/protoreflect/desc/builder"
```
...
*[Read more ≫](https://godoc.org/github.com/tinyhole/pblib/protoreflect/desc/builder)*

----
## Dynamic Messages and Stubs

```go
import "github.com/tinyhole/pblib/protoreflect/dynamic"
```
...
*[Read more ≫](https://godoc.org/github.com/tinyhole/pblib/protoreflect/dynamic)*

```go
import "github.com/tinyhole/pblib/protoreflect/dynamic/grpcdynamic"
```
...
*[Read more ≫](https://godoc.org/github.com/tinyhole/pblib/protoreflect/dynamic/grpcdynamic)*

----
## gRPC Server Reflection

```go
import "github.com/tinyhole/pblib/protoreflect/grpcreflect"
```
...
*[Read more ≫](https://godoc.org/github.com/tinyhole/pblib/protoreflect/grpcreflect)*
