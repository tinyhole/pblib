...
import (
	...
	"github.com/tinyhole/pblib/protoreflect/internal"
	"github.com/tinyhole/pblib/protoreflect/internal/testprotos"
	"github.com/tinyhole/pblib/protoreflect/internal/testutil"
)
			...
			"methods": {(*ServiceDescriptor).GetMethods, []descCase{
				{
					...
					references: map[string]childCases{
						...
						"response": {(*MethodDescriptor).GetOutputType, refs("tinyhole/pblib.protoreflect.desc.Bar")},
					},
				},
				{
				...
				},
				{
					...
					references: map[string]childCases{
						"request":  {(*MethodDescriptor).GetInputType, refs("tinyhole/pblib.protoreflect.desc.Bar")},
