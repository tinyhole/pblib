...
func TestLoadServiceDescriptors(t *testing.T) {
	...
	cases := []struct{ method, request, response string }{
		{"DoSomething", "testprotos.TestRequest", "tinyhole/pblib.protoreflect.desc.Bar"},
		{"DoSomethingElse", "testprotos.TestMessage", "testprotos.TestResponse"},
		{"DoSomethingAgain", "tinyhole/pblib.protoreflect.desc.Bar", "testprotos.AnotherTestMessage"},
