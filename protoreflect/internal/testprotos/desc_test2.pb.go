...
import (
	...
	nopkg "github.com/tinyhole/pblib/protoreflect/internal/testprotos/nopkg"
	pkg "github.com/tinyhole/pblib/protoreflect/internal/testprotos/pkg"
	math "math"
)
...
type Whatchamacallit struct {
	Foos                 *pkg.Foo `protobuf:"varint,1,req,name=foos,enum=tinyhole/pblib.protoreflect.desc.Foo" json:"foos,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
