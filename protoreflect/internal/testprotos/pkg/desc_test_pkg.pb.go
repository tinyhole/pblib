...
type Bar struct {
	Baz                  []Foo    `protobuf:"varint,1,rep,name=baz,enum=tinyhole/pblib.protoreflect.desc.Foo" json:"baz,omitempty"`
...
func init() {
	proto.RegisterEnum("tinyhole/pblib.protoreflect.desc.Foo", Foo_name, Foo_value)
	proto.RegisterType((*Bar)(nil), "tinyhole/pblib.protoreflect.desc.Bar")
}
